...
for (i = 10; i < 21; i ++){
   console.log(stringOfNumbers.concat(i));
}
...
var topQuote = "You don't have to tell me, I was there.";

function goLong(longWord){
   for (i = 0; i < longWord.length; i ++){
      //if (longWord.charAt(i) === " "){
         if (longWord.substring(i) === "t"){
            console.log(longWord.substring(i))
         //if (longWord.i.startsWith(" ") === false){
         //console.log(longWord.charAt(i));
         //console.log(longWord.substring(i, i + 5))
         //console.log(longWord.i.startsWith(" "))
